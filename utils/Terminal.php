	...
	public static function hasFormattingCodes(){
		if(self::$formattingCodes === null){
			...
			if(isset($opts["disable-ansi"])){
				...
				self::$formattingCodes = ((Terminal::getOS() !== "win" and getenv("TERM") != "" and (!function_exists("posix_ttyname") or !defined("STDOUT") or posix_ttyname(STDOUT) !== false)) or isset($opts["enable-ansi"]));
			}
		}
